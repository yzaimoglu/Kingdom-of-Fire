...
import net.citizensnpcs.trait.Controllable.GroundController;
import net.citizensnpcs.trait.Controllable.MovementController;

public class WhiteHorseSpeed implements MovementController {

    private int jumpTicks = 0;
    private double speed = 0.8D;

    private static final float AIR_SPEED = 1.5F;
    private static final float GROUND_SPEED = 20F;
